...
class SoftmaxModel(Model):
    ...
    def add_prediction_op(self):
        ...
        self.W = tf.Variable(tf.random_uniform((self.config.n_features, self.config.n_classes)))
        self.b = tf.Variable(tf.random_uniform([self.config.n_classes]))
    ...
    def add_training_op(self, loss):
        ...
        train_op = optim.minimize(loss, var_list=[self.W, self.b])
        ### END YOUR CODE
        return train_op
