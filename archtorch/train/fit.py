...
class NetworkTrainer:
    def __init__(self, train_dataset, validation_dataset=None, batch_size=128):
    ...
    def set_scheduler(self, optimizer, gamma=0.1, last_epoch=-1):
        return lr_scheduler.StepLR(optimizer, 8, gamma=gamma, last_epoch=last_epoch)
